...
gardendat <- readRDS("04-12-gardens_geo.RDS")
```
  ...
  addCircleMarkers(data = gardendat[gardendat$Managed_by == "IRC New Roots",],
    ...
    addCircleMarkers(data = gardendat[gardendat$Status == "Lost",], group = "Lost gardens",
                   ...
                   popup = paste0("Location: ", gardendat[gardendat$Status == "Lost",]$Garden_property_name, "<br>",
                                  "Managed by: ", "Urban Agriculture Collective", "<br>",
                                  "Size: ", gardendat$Size))%>% 
  addCircleMarkers(data = gardendat[gardendat$Managed_by == "Charlottesville Parks Department",],
                   group = "Parks Dep.",
                   color = "blue", 
                   radius = 6,
                   fillOpacity = 1,
                   ...
                   popup = paste0("Location: ", gardendat[gardendat$Managed_by == "Charlottesville Parks Department",]$Garden_property_name, "<br>",
                                  ...
                                  "Size: ", gardendat$Size)) %>%
      addLayersControl(
        overlayGroups = c("IRC", "Urban Agr Collective", "City Schoolyard", "Lost gardens", "Parks Dep."),
